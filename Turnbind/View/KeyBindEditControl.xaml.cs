...
public partial class KeyBindEditControl : UserControl
{
    ...
    void InputKeysTextBoxKeyDown(object sender, KeyEventArgs e) => m_viewModel.OnInputKey(
            e.Key switch
            {
    ...
    void InputKeysTextBoxMouseDown(object sender, MouseButtonEventArgs e) => m_viewModel.OnInputKey(
